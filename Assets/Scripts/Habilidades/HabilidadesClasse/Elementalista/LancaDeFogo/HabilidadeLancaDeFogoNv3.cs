...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Elementalista/Lança de Fogo/Nv3")]
public class HabilidadeLancaDeFogoNv3 : HabilidadeAtiva
{
    ...
    [SerializeField]
    private int quantidadeDeLancas = 3;
    [SerializeField]
