...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Elementalista/Arco Elemental/Nv3")]
public class HabilidadeArcoElementalNv3 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField] private float buffCastFixo = 0.3f;
