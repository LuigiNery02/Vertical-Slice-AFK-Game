...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Elementalista/Arco Elemental/Nv1")]
public class HabilidadeArcoElementalNv1 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField] private float buffCastFixo = 0.1f;
