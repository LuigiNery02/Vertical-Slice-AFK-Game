...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Elementalista/Meteoro/Nv3")]
public class HabilidadeMeteoroNv3 : HabilidadeAtiva
{
        ...
        foreach (var collider in colliders)
        {
            ...
            if (inimigo != null && inimigo.controlador != personagem.controlador && inimigo._comportamento != EstadoDoPersonagem.MORTO)
            {
                for (int i = 0; i < numeroDeHits; i++)
                {
                    ...
                    personagem.AtualizarCargasElementais("fogo");
