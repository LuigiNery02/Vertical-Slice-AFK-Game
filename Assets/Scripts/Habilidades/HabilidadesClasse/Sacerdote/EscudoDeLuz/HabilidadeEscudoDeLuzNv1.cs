...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Escudo de Luz/Nv1")]
public class HabilidadeEscudoDeLuzNv1 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private int barreiraProjetilValor = 8;
