...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Escudo de Luz/Nv2")]
public class HabilidadeEscudoDeLuzNv2 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private int barreiraProjetilValor = 12;
