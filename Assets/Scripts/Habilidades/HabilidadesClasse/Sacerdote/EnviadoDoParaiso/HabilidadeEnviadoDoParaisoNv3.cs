...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Sacerdote/Enviado do Paraíso/Nv3")]
public class HabilidadeEnviadoDoParaisoNv3 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCuraEscudo = 0.2f;
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAliadoCurado("EnviadoDoParaisoNv3", (IAPersonagemBase aliado, float cura) =>
            {
    ...
    public override void RemoverEfeito(IAPersonagemBase personagem)
    {
        ...
        personagem.RemoverEfeitoPorHabilidadeAliado("EnviadoDoParaisoNv3");
    }
}
