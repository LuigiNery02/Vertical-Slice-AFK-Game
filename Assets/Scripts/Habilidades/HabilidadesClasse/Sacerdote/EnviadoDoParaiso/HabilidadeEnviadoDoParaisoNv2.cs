...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Sacerdote/Enviado do Paraíso/Nv2")]
public class HabilidadeEnviadoDoParaisoNv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCuraEscudo = 0.15f;
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAliadoCurado("EnviadoDoParaisoNv2", (IAPersonagemBase aliado, float cura) =>
            {
    ...
    public override void RemoverEfeito(IAPersonagemBase personagem)
    {
        ...
        personagem.RemoverEfeitoPorHabilidadeAliado("EnviadoDoParaisoNv2");
    }
}
