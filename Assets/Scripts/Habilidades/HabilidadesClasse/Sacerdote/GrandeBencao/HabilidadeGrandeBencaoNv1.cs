...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Grande Benção/Nv1")]
public class HabilidadeGrandeBencaoNv1 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCura = 1f;
    [SerializeField]
    private int numeroDeCuras = 1;
