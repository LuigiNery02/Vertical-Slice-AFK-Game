...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Marca Sagrada/Nv3")]
public class HabilidadeMarcaSagradaNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDanoMarcado = 0.2f;
