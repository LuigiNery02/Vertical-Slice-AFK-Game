...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Marca Sagrada/Nv2")]
public class HabilidadeMarcaSagradaNv2 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDanoMarcado = 0.15f;
