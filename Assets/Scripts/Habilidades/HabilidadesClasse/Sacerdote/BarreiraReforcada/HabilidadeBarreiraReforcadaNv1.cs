...
public class HabilidadeBarreiraReforcadaNv1 : HabilidadePassiva
{
    ...
    [SerializeField]
    private float multiplicadorBonusCura = 1.2f;
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAliadoCurado("BarreiraReforcadaNv1", (IAPersonagemBase aliado, float cura) =>
            {
    ...
    public override void RemoverEfeito(IAPersonagemBase personagem)
    {
        ...
        personagem.RemoverEfeitoPorHabilidadeAliado("BarreiraReforcadaNv1");
    }
}
