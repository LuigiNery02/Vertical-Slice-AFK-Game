...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Sacerdote/Barreira Reforçada/Nv2")]
public class HabilidadeBarreiraReforcadaNv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorBonusCura = 1.5f;
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAliadoCurado("BarreiraReforcadaNv2", (IAPersonagemBase aliado, float cura) =>
            {
    ...
    public override void RemoverEfeito(IAPersonagemBase personagem)
    {
        ...
        personagem.RemoverEfeitoPorHabilidadeAliado("BarreiraReforcadaNv2");
    }
}
