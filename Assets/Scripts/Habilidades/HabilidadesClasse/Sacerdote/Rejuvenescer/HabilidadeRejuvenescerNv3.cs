...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Rejuvenescer/Nv3")]
public class HabilidadeRejuvenescerNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCura = 1.5f;
    [SerializeField]
    private int numeroDeTicks = 5;
    [SerializeField]
