...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Rejuvenescer/Nv1")]
public class HabilidadeRejuvenescerNv1 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCura = 0.5f;
    [SerializeField]
    private int numeroDeTicks = 3;
    [SerializeField]
