...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Sacerdote/Benção Divina/Nv3")]
public class HabilidadeBencaoDivinaNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorCura = 3f;
