...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Sacerdote/Mãoes Abençoadas/Nv2")]
public class HabilidadeMaosAbencoadasNv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorBonusCura = 0.15f;
