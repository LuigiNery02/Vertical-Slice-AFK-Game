...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Ladino/Instinto Predatório/Nv1")]
public class HabilidadeInstintoPredatorioNv1 : HabilidadePassiva
{
    [Header("Configurações da Habilidade")]
    [SerializeField]
    private float multiplicadorDano = 0.05f;
    [SerializeField]
    private float valorHpInimigo = 0.5f;
