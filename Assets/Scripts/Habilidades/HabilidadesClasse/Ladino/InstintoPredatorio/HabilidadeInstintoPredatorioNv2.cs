...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Ladino/Instinto Predatório/Nv2")]
public class HabilidadeInstintoPredatorioNv2 : HabilidadePassiva
{
    [Header("Configurações da Habilidade")]
    [SerializeField]
    private float multiplicadorDano = 0.1f;
    [SerializeField]
