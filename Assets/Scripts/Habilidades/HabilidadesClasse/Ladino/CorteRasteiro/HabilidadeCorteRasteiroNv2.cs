...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Ladino/Corte Rasteiro/Nv2")]
public class HabilidadeCorteRasteiroNv2 : HabilidadeAtiva
{
    [SerializeField]
    private float multiplicadorDeAtaque = 2f;
    [SerializeField]
    private int numeroDeMarcadores = 2;
    [SerializeField]
