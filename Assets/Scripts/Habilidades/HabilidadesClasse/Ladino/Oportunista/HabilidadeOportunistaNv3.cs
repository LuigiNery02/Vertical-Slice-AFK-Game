...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Classe/Ladino/Oportunista/Nv3")]
public class HabilidadeOportunistaNv3 : HabilidadePassiva
{
    [Header("Configurações da Habilidade")]
    [SerializeField]
    private float multiplicadorDano = 0.5f;
