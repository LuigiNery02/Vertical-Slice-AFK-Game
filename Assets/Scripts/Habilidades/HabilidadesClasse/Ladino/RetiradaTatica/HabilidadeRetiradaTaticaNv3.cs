...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Ladino/Retirada Tatica/Nv3")]
public class HabilidadeRetiradaTaticaNv3 : HabilidadeAtiva
{
        ...
        if (personagem.podeAtivarEfeitoHabilidadeAtivaClasse)
        {
            if (base.ChecarAtivacao(personagem) && base.ChecarRuna(personagem, nivel))
            {
                ...
                base.ChecarCastingHabilidade1(personagem, () =>
                {
                    ...
                    personagem.AtivarEfeitoPorAtaque("RetiradaTaticaNv3", (bool acerto) =>
                    {
                        if (acerto)
                        {
