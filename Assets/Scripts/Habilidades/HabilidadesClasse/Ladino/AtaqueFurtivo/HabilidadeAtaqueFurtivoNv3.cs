...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Classe/Ladino/Ataque Furtivo/Nv3")]
public class HabilidadeAtaqueFurtivoNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDeDano = 5;
    [SerializeField]
