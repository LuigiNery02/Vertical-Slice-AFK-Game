...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Arco/Flecha por Flecha/Nv1")]
public class HabilidadeFlechaPorFlechaNv1 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDeDano = 2;
    [SerializeField]
    private float reducaoVelocidadeDeAtaque = 0.5f;
