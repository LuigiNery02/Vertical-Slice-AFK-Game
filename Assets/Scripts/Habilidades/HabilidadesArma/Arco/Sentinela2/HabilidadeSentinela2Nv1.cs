...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Arco/Sentinela2/Nv1")]
public class HabilidadeSentinela2Nv1 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float bonusRange = 0.1f;
