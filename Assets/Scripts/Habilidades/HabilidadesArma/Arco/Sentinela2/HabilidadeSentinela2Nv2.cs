...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Arco/Sentinela2/Nv2")]
public class HabilidadeSentinela2Nv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float bonusRange = 0.2f;
