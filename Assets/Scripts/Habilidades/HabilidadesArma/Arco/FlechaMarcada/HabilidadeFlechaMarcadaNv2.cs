...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Arco/Flecha Marcada/Nv2")]
public class HabilidadeFlechaMarcadaNv2 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDeDano = 1.25f;
        ...
        if (personagem.podeAtivarEfeitoHabilidadeAtivaArma)
        {
            if (base.ChecarAtivacao(personagem) && base.ChecarRuna(personagem, nivel))
            {
                ...
                base.ChecarCastingHabilidade2(personagem, () =>
                {
                    ...
                    personagem.AtivarEfeitoPorAtaque("FlechaMarcadaNv2", (bool acerto) =>
                    {
                        if (acerto)
                        {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("FlechaMarcadaNv2");
