...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Arco/Flecha Marcada/Nv1")]
public class HabilidadeFlechaMarcadaNv1 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorDeDano = 1;
        ...
        if (personagem.podeAtivarEfeitoHabilidadeAtivaArma)
        {
            if (base.ChecarAtivacao(personagem) && base.ChecarRuna(personagem, nivel))
            {
                ...
                base.ChecarCastingHabilidade2(personagem, () =>
                {
                    ...
                    personagem.AtivarEfeitoPorAtaque("FlechaMarcadaNv1", (bool acerto) =>
                    {
                        if (acerto)
                        {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("FlechaMarcadaNv1");
    ...
    IEnumerator EsperarFrame(IAPersonagemBase personagem, float dano, float distancia)
    {
        ...
        personagem.distanciaMinimaParaAtacar = distancia;
        RemoverEfeito(personagem);
    }
