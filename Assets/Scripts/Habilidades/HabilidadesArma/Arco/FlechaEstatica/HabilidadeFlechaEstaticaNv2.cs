...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Arco/Flecha Estatica/Nv2")]
public class HabilidadeFlechaEstaticaNv2 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private int numeroDeRebates = 2;
        ...
        if (personagem.podeAtivarEfeitoHabilidadeAtivaArma)
        {
            if (base.ChecarAtivacao(personagem) && base.ChecarRuna(personagem, nivel))
            {
                ...
                base.ChecarCastingHabilidade2(personagem, () =>
                {
                    ...
                    personagem.AtivarEfeitoPorAtaque("FlechaEstaticaNv2", (bool acerto) =>
                    {
                        if (acerto)
                        {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("FlechaEstaticaNv2");
