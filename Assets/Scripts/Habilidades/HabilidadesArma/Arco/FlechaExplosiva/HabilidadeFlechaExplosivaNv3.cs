...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Arco/Flecha Explosiva/Nv3")]
public class HabilidadeFlechaExplosivaNv3 : HabilidadePassiva
{
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAtaque("FlechaExplosivaNv3", (bool acerto) =>
            {
                if (acerto)
                {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("FlechaExplosivaNv3");
        personagem.GerenciarVFXHabilidade(4, false);
