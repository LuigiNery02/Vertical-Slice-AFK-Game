...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Arco/Flecha Explosiva/Nv2")]
public class HabilidadeFlechaExplosivaNv2 : HabilidadePassiva
{
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (base.ChecarRuna(personagem, nivel))
        {
            ...
            personagem.AtivarEfeitoPorAtaque("FlechaExplosivaNv2", (bool acerto) =>
            {
                if (acerto)
                {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("FlechaExplosivaNv2");
        personagem.GerenciarVFXHabilidade(4, false);
