...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Espada/Espada Bastarda/Nv3")]
public class HabilidadeEspadaBastardaNv3 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicacaoDiminuicaoDeDano = 0.3f;
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (personagem.podeAtivarEfeitoHabilidadePassivaArma)
        {
            if (base.ChecarRuna(personagem, nivel))
            {
                ...
                personagem.AtivarEfeitoPorAtaque("EspadaBastardaNv3", (bool acerto) =>
                {
                    if (acerto)
                    {
    ...
    {
        personagem.RemoverEfeitoPorAtaque("EspadaBastardaNv3");
