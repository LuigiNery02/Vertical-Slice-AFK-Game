...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Espada/Frente de Batalha/Nv2")]

public class HabilidadeFrenteDeBatalhaNv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float buffVelocidadeDeAtaque = 0.15f;
