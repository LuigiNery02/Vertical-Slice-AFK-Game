...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Livro/Tranquilidade/Nv3")]
public class HabilidadeTranquilidadeNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float valorSP = 20;
    [SerializeField]
