...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Livro/Barreira/Nv3")]
public class HabilidadeBarreiraNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorSP = 0.2f;
