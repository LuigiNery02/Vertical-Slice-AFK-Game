...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Livro/Mente Partilhada/Nv1")]
public class HabilidadeMentePartilhadaNv1 : HabilidadePassiva
{
    [SerializeField]
    private float multiplicadorRegeneracaoSP = 0.005f;
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (personagem.podeAtivarEfeitoHabilidadePassivaArma)
        {
            if (base.ChecarRuna(personagem, nivel))
            {
                ...
                personagem.AtivarEfeitoPorHabilidadeAliado("MentePartilhadaNv1", () =>
                {
    ...
    public override void RemoverEfeito(IAPersonagemBase personagem)
    {
        ...
        personagem.RemoverEfeitoPorHabilidadeAliado("MentePartilhadaNv1");
    }
