...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Livro/Segredos do Sangue/Nv2")]
public class HabilidadeSegredosDoSangueNv2 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float reducaoHP = 0.1f;
    [SerializeField]
    private float multiplicadorSP = 0.06f;
    [SerializeField]
