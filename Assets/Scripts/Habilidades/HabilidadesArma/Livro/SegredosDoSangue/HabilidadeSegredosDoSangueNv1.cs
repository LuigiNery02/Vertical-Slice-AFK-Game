...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Livro/Segredos do Sangue/Nv1")]
public class HabilidadeSegredosDoSangueNv1 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField] 
    private float reducaoHP = 0.1f;
    [SerializeField] 
    private float multiplicadorSP = 0.03f;
    [SerializeField] 
