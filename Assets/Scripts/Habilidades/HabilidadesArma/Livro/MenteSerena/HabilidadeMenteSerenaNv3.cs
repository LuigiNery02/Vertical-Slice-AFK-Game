...
[CreateAssetMenu(menuName = "Habilidades/Ativa/Arma/Livro/Mente Serena/Nv3")]
public class HabilidadeMenteSerenaNv3 : HabilidadeAtiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorSP = 0.05f;
    [SerializeField]
