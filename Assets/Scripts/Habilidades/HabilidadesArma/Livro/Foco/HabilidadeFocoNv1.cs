...
public class HabilidadeFocoNv1 : HabilidadePassiva
{
    ...
    [SerializeField]
    private float multiplicadorRecuperacaoSP = 0.01f;
    [SerializeField]
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (personagem.podeAtivarEfeitoHabilidadePassivaArma)
        {
            if (base.ChecarRuna(personagem, nivel))
            {
                ...
                personagem.AtivarEfeitoPorAliadoCurado("FocoNv1", (IAPersonagemBase aliado, float cura) =>
                {
    ...
    {
        personagem.RemoverEfeitoPorDanoCausado("FocoNv1");
