...
[CreateAssetMenu(menuName = "Habilidades/Passiva/Arma/Livro/Foco/Nv2")]
public class HabilidadeFocoNv2 : HabilidadePassiva
{
    [Header("Configurações Habilidade")]
    [SerializeField]
    private float multiplicadorRecuperacaoSP = 0.02f;
    [SerializeField]
    ...
    public override void AtivarEfeito(IAPersonagemBase personagem)
    {
        if (personagem.podeAtivarEfeitoHabilidadePassivaArma)
        {
            if (base.ChecarRuna(personagem, nivel))
            {
                ...
                personagem.AtivarEfeitoPorAliadoCurado("FocoNv2", (IAPersonagemBase aliado, float cura) =>
                {
    ...
    {
        personagem.RemoverEfeitoPorDanoCausado("FocoNv2");
