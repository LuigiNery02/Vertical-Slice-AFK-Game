...
public class Habilidade4CajadoVenenoso : HabilidadeBase
{
    ...
    private void EfeitoHabilidade() //função de efeito da habilidade 
    {
        ...
        {
            case 1:
                personagem.personagem.arma.velocidadeDeAtaque -= 0.07f; //reduz a velocidade de ataque em 0.07
                personagem.personagem.DefinicoesBatalha();
                personagem.AtualizarDadosBatalha();
                break;
            case 2:
                personagem.personagem.arma.velocidadeDeAtaque -= 0.14f; //reduz a velocidade de ataque em 0.14
                personagem.personagem.DefinicoesBatalha();
                personagem.AtualizarDadosBatalha();
                break;
            case 3:
                personagem.personagem.arma.velocidadeDeAtaque -= 0.21f; //reduz a velocidade de ataque em 0.21
                personagem.personagem.DefinicoesBatalha();
                personagem.AtualizarDadosBatalha();
                break;
        }
