...
public class Habilidade7CajadoGelo : HabilidadeBase
{
    ...
    private void EfeitoHabilidade() //função de efeito da habilidade 
    {
        switch (nivel)
        {
            case 1:
                ...
                break;
            case 2:
                //personagem.arma.velocidadeDeAtaque -= 0.6f; //reduz a velocidade de ataque em 0.6
                //personagem.arma.dano -= (_danoOriginal / 5); //diminui o dano em 20%
                _congelamento = true;
                break;
            case 3:
                //personagem.arma.velocidadeDeAtaque -= 0.9f; //reduz a velocidade de ataque em 0.9
