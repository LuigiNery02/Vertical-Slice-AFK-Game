...
public class Habilidade2CajadoGelo : HabilidadeBase
{
    ...
    private void EfeitoHabilidade() //função de efeito da habilidade 
    {
        ...
        {
            case 1:
                personagem.personagem.arma.dano += (_danoOriginal / 100); //aumenta o dano da arma em 1%
            ...
            case 2:
                ...
                break;
            case 3:
                personagem.personagem.arma.dano += (_danoOriginal / 100) * 5; //aumenta o dano da arma em 5%
                personagem.personagem.DefinicoesBatalha();
                personagem.AtualizarDadosBatalha();
                break;
        }
