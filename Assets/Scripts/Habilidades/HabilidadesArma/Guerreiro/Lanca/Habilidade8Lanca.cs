...
public class Habilidade8Lanca : HabilidadeBase
{
    ...
    private void EfeitoHabilidade() //função de efeito da habilidade 
    {
        ...
        {
            case 1:
                personagem.personagem.arma.velocidadeDeAtaque += 0.1f; //aumenta a velocidade de ataque em 0.05
                ...
                break;
            case 2:
                personagem.personagem.arma.velocidadeDeAtaque += 0.2f; //aumenta a velocidade de ataque em 0.1
                personagem.personagem.arma.dano += (_danoOriginal / 100) * 9; //aumenta o dano em 9%
                personagem.personagem.DefinicoesBatalha();
                personagem.AtualizarDadosBatalha();
                break;
            case 3:
                personagem.personagem.arma.velocidadeDeAtaque += 0.3f; //aumenta a velocidade de ataque em 0.15
