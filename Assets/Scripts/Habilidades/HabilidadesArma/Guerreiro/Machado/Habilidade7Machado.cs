    ...
    private void EfeitoHabilidade() //função de efeito da habilidade 
    {
        switch (nivel)
        {
            case 1:
                ...
                //personagem.arma.dano -= (_danoOriginal / 100) * 7.5f; //diminui o dano em 7.5%
                break;
            case 2:
                //personagem.arma.velocidadeDeAtaque -= 0.15f; //reduz a velocidade de ataque em 0.15
                //personagem.arma.dano -= (_danoOriginal / 100) * 15; //diminui o dano em 15%
                break;
            case 3:
                //personagem.arma.velocidadeDeAtaque -= 0.25f; //reduz a velocidade de ataque em 0.25
                //personagem.arma.dano -= (_danoOriginal / 100) * 22.5f; //diminui o dano em 22.5%
                break;
        }
